export const COLORS = {
  ...
  epl_UCL: "hsl(232, 92%, 53%)",
  epl_EL: "hsl(25, 100%, 50%)",
  epl_CF: "hsl(126, 100%, 37%)",
  epl_RLG: "hsl(335, 100%, 58%)",
...
export const SHADOWS = {
  ...
  boxShadowCard: `rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;`,
  boxShadowCardHover: `rgba(0, 0, 0, 0.24) 0px 3px 8px;`,
};

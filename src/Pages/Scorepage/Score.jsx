        ...
        <>
          {showLastGames ? (
            <>
              ...
              {bethistory.length > 10 && (
                <Button
                  variant="outline"
                  size="medium"
                  onClick={() => setShowLastGames(false)}
                >
                  Show all bets
                </Button>
              )}
            ...
            <>
              ...
              <List variant="scorelist">{bethistory.map(GameResult)}</List>
              <Button
                variant="outline"
                size="medium"
                onClick={() => setShowLastGames(true)}
              >
                Show latest bets
              </Button>
            </>
  ...
  return (
    <>
      <StyledGameResult key={index} style={{ "--color": gameState }}>
        ...
        <GameBetPointer bet={bet.result} game={bet.gameResult} />{" "}
        <div>
          <span>{bet.away}</span>
        </div>
      </StyledGameResult>
